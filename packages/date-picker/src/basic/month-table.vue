...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'manyi-ui/src/utils/date-util';
  import { hasClass } from 'manyi-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'manyi-ui/src/utils/util';
