import { arrayFindIndex } from 'manyi-ui/src/utils/util';
import { getCell, getColumnByCell, getRowIdentity } from './util';
import { getStyle, hasClass, removeClass, addClass } from 'manyi-ui/src/utils/dom';
import ElCheckbox from 'manyi-ui/packages/checkbox';
import ElTooltip from 'manyi-ui/packages/tooltip';
    ...
    return (
      <table
        ...
        <tbody>
          ...
          <my-tooltip effect={this.table.tooltipEffect} placement="top" ref="tooltip" content={this.tooltipContent}></my-tooltip>
        </tbody>
      </table>
    );
  },
